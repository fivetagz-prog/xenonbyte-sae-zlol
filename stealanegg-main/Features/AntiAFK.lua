--==================================================
-- XENONBYTE HUB | FEATURE | Anti AFK
...
local function EnableAntiAFK()
    ...
    MouseThread = task.spawn(function()
        while AntiAFKEnabled do
            ...
            DoMouseMove()
            print("[XENONBYTE] Anti AFK: Mouse Move")
        end
    end)
    ...
    CameraThread = task.spawn(function()
        while AntiAFKEnabled do
            ...
            if not AntiAFKEnabled then break end
            DoCameraRotation()
            print("[XENONBYTE] Anti AFK: Camera Rotation")
        end
    end)
    ...
    ZoomThread = task.spawn(function()
        while AntiAFKEnabled do
            ...
            if not AntiAFKEnabled then break end
            DoCameraZoom()
            print("[XENONBYTE] Anti AFK: Camera Zoom")
        end
    end)

    print("[XENONBYTE] Anti AFK: ON (3 Methods)")
end
