-- ==================================================
-- XENONBYTE HUB | FEATURE | Walk Speed
...
local function SetWalkSpeedValue(Value)
    ...
    print("[XENONBYTE] Walk Speed Value: " .. WalkSpeedValue)
end
...
local function ToggleWalkSpeed()
    ...
    if WalkSpeedEnabled then
        StartWalkSpeed()
        print("[XENONBYTE] Walk Speed: ON (" .. WalkSpeedValue .. ")")
    else
        StopWalkSpeed()
        print("[XENONBYTE] Walk Speed: OFF")
    end
end
