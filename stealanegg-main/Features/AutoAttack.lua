-- ==================================================
-- XENONBYTE HUB | FEATURE | Auto Attack
...
local function EnableAutoEquip()
    ...
    EquipBat()
    print("[XENONBYTE] Auto Equip Bat: ON")
end
...
local function DisableAutoEquip()
    ...
    print("[XENONBYTE] Auto Equip Bat: OFF")
end
...
local function EnableAutoHit()
    ...
    print("[XENONBYTE] Auto Fire Remote (Range 17 + Fast): ON")
end
...
local function DisableAutoHit()
    ...
    print("[XENONBYTE] Auto Fire Remote: OFF")
end
