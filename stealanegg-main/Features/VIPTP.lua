-- ==================================================
-- XENONBYTE HUB | FEATURE | VIPTP (AFK Farm Only)

-- VIP is intentionally free/unlocked in XenonByte.
local VIP_UNLOCKED = true
_G.XENONBYTE_VIPUnlocked = true
...
local function AutoStop()
    ...
    if _G.XENONBYTE_FarmingManager and _G.XENONBYTE_FarmingManager.OnVIPTPComplete then
        task.spawn(function()
            task.wait(0.5)
            _G.XENONBYTE_FarmingManager.OnVIPTPComplete()
        end)
    end
end
...
-- ==================================================
_G.XENONBYTE_VIPTP = {
    IsVIPUnlocked = function() return VIP_UNLOCKED end,
    Enable = Enable,
    Disable = Disable,
...
if _G.XENONBYTE_CharacterSystem then
    _G.XENONBYTE_CharacterSystem:RegisterFeature({
        Name = "VIPTP",
        Enable = Enable,
        Disable = Disable,
        IsEnabled = function() return Running end,
