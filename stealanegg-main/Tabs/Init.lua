...
function TabsManager:SelectTab(
    SelectedTab,
    SelectedPage
)
...
_G.XENONBYTE_TabsManager =
    TabsManager

print(
    "XenonByte Tabs Manager Loaded"
)
