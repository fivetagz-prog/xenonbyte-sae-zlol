...
-- INFO CONTENT
--==================================================
CreateSectionTitle(InfoPage, "XENONBYTE HUB | Steal An Egg", 1)
...
LinkStroke.Color = Color3.fromRGB(210, 210, 210)
...
CopyBtn.BackgroundColor3 = Color3.fromRGB(215, 215, 215)
...
CopyStroke.Color = Color3.fromRGB(235, 235, 235)
...
local function CopyDiscord()
    ...
    if Success then
        ...
        print("[XENONBYTE] Discord Link Copied: " .. DISCORD_LINK)
    else
        CopyBtn.Text = "FAILED!"
        ...
        warn("[XENONBYTE] Failed to copy Discord link")
    end
end
