...
local function ToggleAutoEquip()
    ...
    if AutoEquipCheck.Visible then
        AutoEquipCheckButton.BackgroundColor3 = Color3.fromRGB(210, 210, 210)
        AutoEquipStroke.Color = Color3.fromRGB(245, 245, 245)
        if _G.XENONBYTE_AutoAttack then
            _G.XENONBYTE_AutoAttack.EnableAutoEquip()
        end
    else
        AutoEquipCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AutoEquipStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.XENONBYTE_AutoAttack then
            _G.XENONBYTE_AutoAttack.DisableAutoEquip()
        end
    end
end
...
local function ToggleAutoHit()
    ...
    if AutoHitCheck.Visible then
        AutoHitCheckButton.BackgroundColor3 = Color3.fromRGB(210, 210, 210)
        AutoHitStroke.Color = Color3.fromRGB(245, 245, 245)
        if _G.XENONBYTE_AutoAttack then
            _G.XENONBYTE_AutoAttack.EnableAutoHit()
        end
    else
        AutoHitCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AutoHitStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.XENONBYTE_AutoAttack then
            _G.XENONBYTE_AutoAttack.DisableAutoHit()
        end
    end
end
